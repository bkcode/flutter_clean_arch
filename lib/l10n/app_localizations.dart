...
abstract class AppLocalizations {
  ...
  /// No description provided for @themeTip.
  ///
  /// In en, this message translates to:
  /// **'Current Theme'**
  String get themeTip;
  ...
  /// No description provided for @goAuthorizedPage.
  ///
  /// In en, this message translates to:
  /// **'Go to Authorized Page'**
  String get goAuthorizedPage;

  /// No description provided for @authorizedPageTitle.
  ///
  /// In en, this message translates to:
  /// **'Authorized Page'**
  String get authorizedPageTitle;
  ...
  ///
  /// In en, this message translates to:
  /// **'Variable passed to the multi-language rendering: {variable}'**
  String variable(String variable);

  /// No description provided for @applesTip.
  ///
  /// In en, this message translates to:
  /// **'Plural form processing of multi-language'**
  String get applesTip;
  ...
  /// No description provided for @genderTip.
  ///
  /// In en, this message translates to:
  /// **'Greet users based on their gender in multiple languages.'**
  String get genderTip;
  ...
  /// A message displaying today's date.
  ///
  /// In en, this message translates to:
  /// **'Today is {date}'**
